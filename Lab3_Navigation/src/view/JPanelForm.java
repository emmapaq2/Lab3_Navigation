   ...
   ImageIcon profilePicture;
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            //Create instance of model.Patient
            Patient p_Data = new Patient();
            p_Data.setFname(fname);
            p_Data.setLname(lname);
            p_Data.setAge(age);
            p_Data.setEmail(email);
            p_Data.setMessage_(message_);
            p_Data.setGender(gender);
            p_Data.setPat_Type(pat_Type);
            p_Data.setProfilePicture(profilePicture);
            
            JPanelView newJPView = new JPanelView(p_Data);
